...
main.out:	DataStructure.o EfficientMap.o Keyify.o QueryParser.o QueryLexer.o Schema.o Record.o File.o DBFile.o Comparison.o Function.o RelOp.o Catalog.o QueryOptimizer.o QueryCompiler.o EfficientMap.o main.o
	$(CC) -o main.out main.o QueryParser.o QueryLexer.o Schema.o Record.o File.o DBFile.o Comparison.o Function.o RelOp.o EfficientMap.o Catalog.o QueryOptimizer.o QueryCompiler.o -lfl -lsqlite3
